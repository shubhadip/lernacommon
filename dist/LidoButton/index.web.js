...
var LidoButton = function (props) {
    ...
    return (React.createElement(react_native_1.TouchableOpacity, { onPress: handlePress, style: [index_style_1.default.button, props.style, clicked], activeOpacity: 1, onPressOut: function () { return setClicked({}); }, onPressIn: function () { return setClicked(clickedStyle); } },
